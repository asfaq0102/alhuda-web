    ...
    return (
        <div className="min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 font-montserrat">
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(135deg, rgba(30, 58, 138, 0.75), rgba(67, 56, 202, 0.65)), url('/images/Ilahiya.jpg')`,
            ...
            >
                ...
                <div className="absolute top-20 left-10 w-20 h-20 bg-amber-400/20 rounded-full animate-float animate-pulse"></div>
                <div className="absolute top-40 right-20 w-16 h-16 bg-emerald-400/20 rounded-full animate-bounce delay-300"></div>
                <div className="absolute bottom-32 left-20 w-12 h-12 bg-violet-400/20 rounded-full animate-pulse delay-700"></div>
                <div className="absolute top-60 left-1/3 w-8 h-8 bg-rose-400/30 rounded-full animate-float delay-1000"></div>
                <div className="absolute bottom-40 right-1/4 w-14 h-14 bg-cyan-400/20 rounded-full animate-bounce delay-500"></div>
                                        ...
                                        <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black text-white mb-12 leading-tight relative">
                                            {slide.title.map((word, wordIndex) => (
                                                <div key={wordIndex} className="relative my-4">
                                                    <span
                                                        className="block text-6xl sm:text-7xl lg:text-8xl font-black text-white animate-gradient tracking-wider leading-none"
                                                        style={{
                                                    ...
                                                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/30 via-cyan-400/30 to-blue-400/30 blur-xl opacity-30 animate-pulse"></div>
                                                </div>
                                            ))}
                                        </h1>       
                                        <p
                                            className="text-xl sm:text-2xl text-white mb-12 max-w-4xl mx-auto leading-relaxed transition-all duration-1000"
                                            style={{
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-24 animate-fade-in">
                        <h2 className="text-5xl font-bold text-white mb-6 font-montserrat">Campus Life</h2>
